...

{
    ...
    public class AuthController : ControllerBase
    {
        ...
        // login viejo sin mfa, lo dejo comentado por si acaso
        //[HttpPost("login")]
        //public async Task<IActionResult> Login(LoginDTO model)
        //{
        //    string cs = "server=localhost;database=roseadb;user=root;password=sam93;";
...
[HttpPost("enable-mfa")]
    public async Task<IActionResult> EnableMfa(MFADTo data)
    {
        ...
        //[HttpPost("enable-mfa")]
        //public async Task<IActionResult> EnableMfa(EnableMFADto data)
        //{
        //    string cs = "server=localhost;database=roseadb;user=root;password=sam93;";
        ...
        //    var sql = "UPDATE usuarios SET mfa_enabled=1,mfa_secret=@secret WHERE email=@email";

        //    var cmd = new MySqlCommand(sql, conn);

        //    cmd.Parameters.AddWithValue("@secret", data.Code);
        //    cmd.Parameters.AddWithValue("@email", data.Email);
